...
\begin{itemize}[leftmargin=*]
  ...
  \begin{itemize}[leftmargin=*]
    ...
    \item Deploy stack: \texttt{sudo ./scripts/deploy\_prod.sh}
...
\begin{itemize}[leftmargin=*]
  ...
  \begin{itemize}[leftmargin=*]
    ...
    \item \texttt{GET /cache} --- inspect in-memory price cache (refreshed every 5s for tracked symbols; re-populates after trades are created/updated).
